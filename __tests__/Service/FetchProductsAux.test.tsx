...
import { fetchItensByCategory, fetchCategories, fetchItensByTitle } from '../../src/service/FetchProductsAux';
import { Product, Category, ProductByTitle } from '../../src/types/Product';
